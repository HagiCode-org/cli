...
/**
 * Published character template detail payload.
 */
export type PCode_Web_Controllers_CharacterTemplateDetailResponseDto = {
  /**
  ...
  /**
   * Ordered SOUL template identifiers used to compose the final local SOUL draft.
   */
  soulTemplateIds?: Array<string> | null;
  /**
   * Ordered Trait template identifiers used to rebuild the local Trait list.
   */
  traitTemplateIds?: Array<string> | null;
  /**
