...
import type { PCode_Application_Contracts_Dto_DataManagement_ImageStorageFileSummaryDto_PCode_Application_Contracts_Version_0_1_0_0_Culture_neutral_PublicKeyToken_null_ } from '../models/PCode_Application_Contracts_Dto_DataManagement_ImageStorageFileSummaryDto_PCode_Application_Contracts_Version_0_1_0_0_Culture_neutral_PublicKeyToken_null_';
...
import type { PCode_Application_Contracts_Dto_DataManagement_MessageDatabaseFileSummaryDto_PCode_Application_Contracts_Version_0_1_0_0_Culture_neutral_PublicKeyToken_null_ } from '../models/PCode_Application_Contracts_Dto_DataManagement_MessageDatabaseFileSummaryDto_PCode_Application_Contracts_Version_0_1_0_0_Culture_neutral_PublicKeyToken_null_';
...
export class AppService {
  ...
  /**
   * @returns Volo_Abp_Application_Dtos_PagedResultDto_1<PCode_Application_Contracts_Dto_DataManagement_ImageStorageFileSummaryDto_PCode_Application_Contracts_Version_0_1_0_0_Culture_neutral_PublicKeyToken_null_> OK
   * @throws ApiError
   */
  ...
  /**
   * @returns Volo_Abp_Application_Dtos_PagedResultDto_1<PCode_Application_Contracts_Dto_DataManagement_MessageDatabaseFileSummaryDto_PCode_Application_Contracts_Version_0_1_0_0_Culture_neutral_PublicKeyToken_null_> OK
   * @throws ApiError
   */
